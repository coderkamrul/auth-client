            ...
            <div className='grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center'>
                <div className=' w-full md:w-[32rem] flex flex-col space-y-6'>
                    ...
                    <div className='lg:text-lg text-[#191919] md:text-base text-sm'>
                        Lorem ipwum dolor sit amet consectetur adipisicing alit. temporibus maxine quibusdan neno! Cuque explicabo adipisci consequuntur nobis laboriosam at vero?
                    </div>
                ...
                <img src={sheef2} alt='' className='h-[32rem]' />
            </div>
        </div>
    </div>
  )
